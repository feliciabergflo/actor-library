        ...
        <main className="mt-5">
            ...
            <div className="row g-2">
                {props.actors.map( actor => (
                    <button key={actor.id} onClick={(e) => { props.getActor(e, actor.id) }} className="shadow col-6 col-md-3 mb-3 border-0 bg-light" data-bs-toggle="modal" data-bs-target="#exampleModal">
